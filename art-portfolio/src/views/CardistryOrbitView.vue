        ...
        <div class="hero-content">
          <div class="hero-text">
            ...
            <h1 class="collection-title">
              <span class="title-main">Cardistry Orbit</span>
              <span class="title-subtitle">卡牌艺术 · 轨道</span>
            </h1>
    ...
    <section class="zen-gallery">
      <div class="gallery-flow">
        ...
        <div class="zen-header">
          ...
          <h2 class="zen-title">Orbit Moments</h2>
          <p class="zen-subtitle">Studio • 2024</p>
          <div class="header-line"></div>
        </div>
        ...
        <div class="photo-stream">
          ...
          <div v-if="artworks.length === 0" class="fallback-notice">
            <p>当前文件夹中仅包含 RAW 图像（.ARW），浏览器无法直接显示。请将照片转换为 JPG/PNG 格式并放置在 <code>/public/Cardistry_Orbit</code> 目录下。</p>
          </div>
        </div>
      </div>
    </section>
...
const artworks = ref<Artwork[]>([
  { id: 1, title: 'Orbit #01', description: '轨道之间的流动与平衡。', image: '/Cardistry_Orbit/DSC03810.JPG', filename: 'DSC03810.JPG', location: 'Studio' },
  { id: 2, title: 'Orbit #02', description: '轨道之间的流动与平衡。', image: '/Cardistry_Orbit/DSC03817.JPG', filename: 'DSC03817.JPG', location: 'Studio' },
  { id: 3, title: 'Orbit #03', description: '轨道之间的流动与平衡。', image: '/Cardistry_Orbit/DSC03826.JPG', filename: 'DSC03826.JPG', location: 'Studio' },
  { id: 4, title: 'Orbit #04', description: '轨道之间的流动与平衡。', image: '/Cardistry_Orbit/DSC03829.JPG', filename: 'DSC03829.JPG', location: 'Studio' },
  { id: 5, title: 'Orbit #05', description: '轨道之间的流动与平衡。', image: '/Cardistry_Orbit/DSC03850.JPG', filename: 'DSC03850.JPG', location: 'Studio' },
  { id: 6, title: 'Orbit #06', description: '轨道之间的流动与平衡。', image: '/Cardistry_Orbit/DSC03858.JPG', filename: 'DSC03858.JPG', location: 'Studio' },
  { id: 7, title: 'Orbit #07', description: '轨道之间的流动与平衡。', image: '/Cardistry_Orbit/DSC03862.JPG', filename: 'DSC03862.JPG', location: 'Studio' },
  { id: 8, title: 'Orbit #08', description: '轨道之间的流动与平衡。', image: '/Cardistry_Orbit/DSC03892.jpg', filename: 'DSC03892.jpg', location: 'Studio' },
  { id: 9, title: 'Orbit #09', description: '轨道之间的流动与平衡。', image: '/Cardistry_Orbit/DSC03895.JPG', filename: 'DSC03895.JPG', location: 'Studio' }
])
